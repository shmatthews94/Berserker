...
namespace Berserker
{
    ...
    public class Enemy : Sprite
    {
        ...
        public int prevSpriteX;
        public int prevSpriteY;

        public TimeSpan elapsedWanderTime;
        public TimeSpan targetWanderTime;

        public TimeSpan elapsedAttackTime;

        Random rand = new Random();
        public int wanderDir;
        ...
        public virtual void Attack(Controls controls, Player player, List<Enemy> Enemies, List<Tree> Trees)
        {
        ...
        public virtual void Update(Controls controls, GameTime gameTime, int x, int y, Player p, List<Enemy> Enemies, List<Tree> Trees)
        {
        ...
        public virtual void Move(GameTime gameTime, int x, int y, Player p, List<Tree> Trees)
        {
            prevSpriteX = spriteX;
            prevSpriteY = spriteY;
        ...
        public virtual bool playerNearby(int x, int y)
        {
        ...
        public void flee(int x, int y, Player p, List<Tree> Trees)
        {
            throw new NotImplementedException();
        }

        public virtual void pursue(int x, int y, Player p, List<Tree> Trees)
        {
            if (prevSpriteX > x)
            {
                spriteX -= speed;
        ...
        public virtual void wander(GameTime gameTime, Player p, List<Tree> Trees)
        {
        ...
        public void resolveCollisionsX(Player p, List<Tree> Trees)
        {
        ...
        public void resolveCollisionsY(Player p, List<Tree> Trees)
        {
        ...
        public bool checkCollisions(Sprite s)
        {
        ...
        public void pushBack(Player p, List<Tree> Trees, string facing)
        {
            elapsedAttackTime = TimeSpan.Zero;
            switch (facing)
            {
